...
class NewAdmissionController extends GetxController {
  ...
  RxString autoGeneratedRollNo = ''.obs;
  RxString autoGeneratedGrNo = ''.obs;
  ...
  void onInit() {
    ...
    if (!isEditMode.value) {
      ...
      // Auto-generate roll number and GR number for new students
      _generateRollNumber();
      _generateGrNumber();
    }
  ...
  Future<void> _generateRollNumber() async {
    try {
      final nextRollNo = await StudentService.getNextRollNumber();
      print('NewAdmissionController: Generated roll number: $nextRollNo');
      autoGeneratedRollNo.value = nextRollNo;
      rollNoController.text = nextRollNo;
      print(
        'NewAdmissionController: Set rollNoController.text to: ${rollNoController.text}',
      );
      print(
        'NewAdmissionController: Set autoGeneratedRollNo.value to: ${autoGeneratedRollNo.value}',
      );
    } catch (e) {
      print('NewAdmissionController: Error generating roll number: $e');
      // Fallback to empty string if generation fails
      autoGeneratedRollNo.value = '';
      rollNoController.text = '';
    }
  }

  Future<void> _generateGrNumber() async {
    try {
      final nextGrNo = await StudentService.getNextGrNumber();
      print('NewAdmissionController: Generated GR number: $nextGrNo');
      autoGeneratedGrNo.value = nextGrNo;
      grNoController.text = nextGrNo;
      print(
        'NewAdmissionController: Set grNoController.text to: ${grNoController.text}',
      );
      print(
        'NewAdmissionController: Set autoGeneratedGrNo.value to: ${autoGeneratedGrNo.value}',
      );
    } catch (e) {
      print('NewAdmissionController: Error generating GR number: $e');
      // Fallback to empty string if generation fails
      autoGeneratedGrNo.value = '';
      grNoController.text = '';
    }
  }
  ...
  Future<void> createNewStudent() async {
    try {
      ...
      // Ensure auto-generated identifiers exist even after form resets.
      if (autoGeneratedRollNo.value.trim().isEmpty) {
        await _generateRollNumber();
      }
      if (autoGeneratedGrNo.value.trim().isEmpty) {
        await _generateGrNumber();
      }
      ...
      print(
        'NewAdmissionController: Using roll number: ${autoGeneratedRollNo.value}',
      );
      print(
        'NewAdmissionController: Using GR number: ${autoGeneratedGrNo.value}',
      );
      final student = StudentModel(
        rollNo: autoGeneratedRollNo.value,
        grNo: autoGeneratedGrNo.value,
      ...
      print(
        'NewAdmissionController: Created student model: ${student.studentName}, Roll No: ${student.rollNo}, autoGeneratedRollNo: ${autoGeneratedRollNo.value}',
      );
  ...
  void resetForm() {
    ...
    // Regenerate auto values for the next new admission.
    if (!isEditMode.value) {
      _generateRollNumber();
      _generateGrNumber();
    }
  ...
  void loadStudentForEdit(StudentModel student) {
    ...
    autoGeneratedRollNo.value =
        student.rollNo; // For edit mode, use existing roll number
