...
class MonthlyPendingFeesView extends StatelessWidget {
  const MonthlyPendingFeesView({super.key});
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 8.w),
                Text(
                  'Pending Monthly Fees (${fees.length})',
                  style: GoogleFonts.poppins(
                    fontSize: 14.sp,
                    fontWeight: FontWeight.w600,
                    color: Colors.orange[800],
              ...
              child: Column(
                children: List.generate(fees.length, (index) {
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: _buildMonthlyFeeCells(fee, controller, context),
                    ),
                  );
                }),
              ),
  ...
  List<Widget> _buildMonthlyFeeCells(
    MonthlyFeeModel fee,
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${((fee.paidAmount / fee.amount) * 100).toStringAsFixed(1)}%',
                                        style: GoogleFonts.poppins(
                                          fontSize: 12.sp,
                                          fontWeight: FontWeight.w600,
                                          color: fee.paidAmount == fee.amount
                                              ? Colors.green[700]
                                              : AppColors.primary,
                                        ),
                                      ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8.h),
                              _buildInfoRow('Month', fee.month ?? 'No month'),
                              SizedBox(height: 8.h),
                              _buildInfoRow(
                                'Monthly Fees',
                                'PKR ${fee.amount.toStringAsFixed(0)}',
                                  ...
                                  onPressed: controller.isLoading.value
                                      ...
                                      : () async {
                                          if (formKey.currentState
                                            ...
                                            if (success) {
                                              Get.back(); // Close payment dialog first

                                              // Wait a bit then show success dialog
                    ...
                    TweenAnimationBuilder<double>(
                      ...
                      builder: (context, opacity, child) {
                        return Opacity(
                          opacity: opacity,
                          child: Text(
                            'The monthly fee payment has been processed successfully.',
                            style: GoogleFonts.inter(
                              fontSize: 14.sp,
                              color: Colors.grey[600],
                              height: 1.4,
                              ...
                              Expanded(
                                child: ElevatedButton.icon(
                                  onPressed: () async {
                                    ...
                                    final month = fee.month ?? 'Monthly Fee';
  ...
  void _showGenerateChallanDialog(BuildContext context, MonthlyFeeModel fee) {
    final amountController = TextEditingController();
    final remarksController = TextEditingController();
    final formKey = GlobalKey<FormState>();
    String selectedFeesType = 'Monthly'; // Default to Monthly type
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              onChanged: (value) {
                                selectedFeesType = value ?? 'Monthly';
                              },
                              validator: (value) {
                                if (value == null || value.isEmpty) {
