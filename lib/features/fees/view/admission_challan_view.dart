...
class AdmissionChallanView extends GetView<ChallanController> {
  const AdmissionChallanView({super.key});
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.receipt_long, color: Colors.blue[700], size: 20.sp),
                SizedBox(width: 8.w),
                Obx(() {
                  final challans = controller.getChallansForSection(
                    ChallanSection.admissionChallans,
                  );
                  return Text(
                    'Admission Challans (${challans.length})',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 12.h),
                          _buildDetailRow('Month', challan.month ?? 'N/A'),
                          SizedBox(height: 12.h),
                          _buildDetailRow(
                            'Date Generated',
                            DateFormat(
