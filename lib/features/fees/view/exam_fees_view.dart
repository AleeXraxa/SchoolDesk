...
class ExamFeesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final examController = Get.put(ExamFeesController(), permanent: true);

    return Scaffold(
      backgroundColor: const Color(0xFFF8FAFD),
      body: Column(
        children: [
          _buildHeader(examController),
          _buildSearchBar(examController),
          Expanded(
  ...
  Widget _buildHeader(ExamFeesController examController) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() {
            if (examController.isViewFiltered.value) {
              return Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Spacer(),
                    TextButton.icon(
                      onPressed: () => examController.clearViewFilter(),
  ...
  Widget _buildSearchBar(ExamFeesController examController) {
    return Container(
              ...
              child: TextField(
                controller:
                    TextEditingController(
                        text: examController.searchQuery.value,
                      )
                      ..selection = TextSelection.collapsed(
                        offset: examController.searchQuery.value.length,
                      ),
                onChanged: examController.updateSearchQuery,
